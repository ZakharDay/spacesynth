...
import * as sunSynth from '../tunes/sun_synth.js'
import * as moonSynth from '../tunes/moon_synth.js'
import * as saturnSynth from '../tunes/saturn_synth.js'
import * as plutoSynth from '../tunes/pluto_synth.js'
import * as neptuneSynth from '../tunes/neptune_synth.js'
import * as marsSynth from '../tunes/mars_synth.js'

import React, { Component } from 'react'

import WelcomeScreen from '../views/WelcomeScreen.jsx'
import TimeMachine from '../views/TimeMachine.jsx'
import SynthRoom from '../views/SynthRoom.jsx'

import { moshier, constant, processor } from '../ephemeris-0.1.0-modified.js'
...
export default class Container extends Component {
  ...
  setupSaturn = () => {
    const { altaz, constellation, aberration } =
  ...
  renderSynthRoom = () => {
    const { timeShift, currentDate, isSynthRoomVisible, instruments } =
      this.state
